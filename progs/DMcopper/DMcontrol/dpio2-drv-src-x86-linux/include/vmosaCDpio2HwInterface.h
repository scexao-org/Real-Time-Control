...
class CDpio2HwInterface
{
  public:
    ...
    inline unsigned long getBaseAddressOfFifo();
    inline unsigned long getBaseAddressOfSram();
    inline unsigned long getBaseAddressOfFlash();
...
/**/
unsigned long CDpio2HwInterface::getBaseAddressOfFifo()
{
  ...
  return ( (unsigned long) m_hDpio2->user.fifo_base );

}


/**/
unsigned long CDpio2HwInterface::getBaseAddressOfSram()
{
  ...
  return ( (unsigned long) ( (unsigned long) m_hDpio2->user.ctrl_base + DPIO2_SRAM_BASE_ADDRESS ) );

}


/**/
unsigned long CDpio2HwInterface::getBaseAddressOfFlash()
{
  ...
  return ((unsigned long) ( (unsigned long) m_hDpio2->user.ctrl_base + DPIO2_FLASH_BASE_ADDRESS ));
